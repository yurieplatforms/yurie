...
import type { ExaSearchInput, ExaFindSimilarInput, ExaAnswerInput } from '@/services/exa'
import type { ExaSearchCategory, ExaSearchType } from '@/types'

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function getExaTools(sseHandler: SSEHandler): any[] {
  if (!isExaAvailable()) {
    return []
  }

...
export async function POST(request: Request) {
  try {
    ...
    const INSTRUCTIONS_MARKDOWN = [
      ...
      '1. **TL;DR** — one sentence when helpful.',
      '2. **Answer** — the direct solution or result.',
      '3. **Why / Key points** — the rationale or quick highlights.',
      '4. **Steps** — numbered, if the user must do something.',
      '5. **Caveats** — limits, assumptions, uncertainties.',
      '6. **Next steps** — optional, only when genuinely useful.',
      '',
